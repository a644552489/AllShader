...
half GetBlendAreaMask(float3 positionWS)
{
...
#define RENDING_MIX_AREA_FOG(varyings, positionWS)																\
	half fogMask = GetBlendAreaMask(positionWS);																\
	varyings._fogCoord = float4((1 - fogMask) * varyings._fogCoord.rgb, max(fogMask, varyings._fogCoord.a));

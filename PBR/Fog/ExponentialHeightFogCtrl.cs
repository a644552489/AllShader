...
public class ExponentialHeightFogCtrl : MonoBehaviour
{
    ...
    [Space(30)]
    [Header("环境光烘培")]
    public Light GiveLightForMe =null;
    ...
    private static float RayOriginTerm(float density, float heightFalloff, float heightOffset,Camera cam)
    {
    ...
    void SetSHValue()
    {
        ...
        {
            Shader.SetGlobalVector("_RolanLightDir", -GiveLightForMe.transform.forward);
            Shader.SetGlobalColor("_RolanLightColor", GiveLightForMe.color * GiveLightForMe.intensity);
        }

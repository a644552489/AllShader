Shader "ZShader/Toon/Toon_ActorBody_test"
{
	Properties
	{
		_MainColor("MainColor",Color) = (1,1,1,1)
		_BodyAlPah("角色透明度",Range(0,1)) = 1
		_TexAlaphDelta("贴图透明度调整值",Range(0, 1)) = 1
	...
	SubShader
	{
		...
		Tags 
		{
			...
			"RenderType"="Opaque" "Queue"="AlphaTest"
		}
		...
		Stencil {
			...
			#pragma multi_compile _ USE_RIM_LIGHT_ON_V2
	...
	CustomEditor "ToonActorShaderGUI_test"
}

...
#ifdef USE_SHADOWMAP
	o.shadowCoord = GetShadowCoord(worldPos);
#endif
...
fixed4 frag (v2f i) : SV_Target
{
...
#ifdef USE_SHADOWMAP
	half inShadow = SampleShadowMap(worldPos, i.shadowCoord);
#else
	half inShadow = 0.0;
#endif
	...
	half3 finalDiffuseColor  = lerp(shadowCol,mainCol.rgb, (1 - inShadow) * diffuseStep);

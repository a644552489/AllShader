Shader "ZShader/Toon/Toon_SceneObj"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			// 闪避
			#pragma multi_compile __ GSTORE_USE_DODGE_EFFECT GSTORE_USE_DODGE_EFFECT_DARK

			#pragma multi_compile _ _HeightDissovleOn
			#include "DissolveCG.cginc"
		...
		Pass{
			...
			#pragma multi_compile _HeightDissovleOn
			#include "DissolveCG.cginc"

...
Shader "PBR/Gamma/ActorBodyUI_test"
{
    Properties
    {
		...
		_FabricScatterColor("_FabricScatterColor", Color) = (1, 0, 0, 1)
		_FabricScatterScale("_FabricScatterScale", Float) = 1
	...
	SubShader
    {
        Tags {
			...
			"UIType" = "True"
			"RenderType"="Transparent" "PerformanceChecks"="False" "Queue"="Transparent-1"
		}//减一是为了防止特效穿插
        LOD 200
        ...
        Pass
        {
			...
			#pragma shader_feature _ _FABRIC
        ...
        /*Pass
        {
			...
			#pragma multi_compile _ _FABRIC

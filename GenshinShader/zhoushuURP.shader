           ...
           float4 frag(VertexOutput i) : COLOR //像素shader
            {
               ...
               float4 shadowCoord = TransformWorldToShadowCoord(i.posWS.xyz);
                ...
                //Ramp阴影
                half3 ShadowColor = baseColor.rgb * _ShadowMultColor.rgb ;// * (1- LightMapColor.r);
                half3 DarkShadowColor = baseColor.rgb * _DarkShadowMultColor.rgb;//  *(1- LightMapColor.r);
           ...
           //     half Ramp = CalculateRamp(lambert);
            ...
            //    Ramp *= regularShadow;
             ...
             //   FinalColor.rgb = lerp(DarkShadowColor , ShadowColor, Ramp) * shadow;
                ...
                half3 RampNight = SAMPLE_TEXTURE2D(_RampMap , sampler_RampMap , half2(halfLambert , LightMapColor.a * 0.45)) ;
                half3 RampSun =  SAMPLE_TEXTURE2D(_RampMap , sampler_RampMap , half2(halfLambert , LightMapColor.a * 0.45 +0.55)) ;
...
//===========================================================================================================
    ...
    // Specular-----------------------------------------------------------------------------------  
              ...
              //  half spec = smoothstep(0, specSmoothness, nh) *step(0.1, LightMapColor.r);
                 half4 specularColor = _EnableSpecular * _LightSpecColor  * LightMapColor.r * mapCapColor * _MetalIntensity * halfLambert;
...
inline float4 CalculateOutlineVertexClipPosition(float4 vertex ,float3 normal , float4 color)
{                                                                                                //y = near plane
    ...
    projectedNormal.x *= aspect;
     ...
     return o_vertex;
            ...
            VertexOutput vert(VertexInput v)
            {
                ...
                o.pos = CalculateOutlineVertexClipPosition(v.vertex , v.tangent.xyz , v.color);

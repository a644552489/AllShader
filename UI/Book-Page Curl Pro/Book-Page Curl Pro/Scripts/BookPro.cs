...
public class BookPro : MonoBehaviour
{
    ...
    public GameObject[] NextPage = new GameObject[2];
    ...
    public void UpdatePages()
    {
        ...
        else
        {
            ...
            switch (previousPaper)
            {
                case -1:
                    previousPaper = EndFlippingPaper;
                    break;
                case -2:
                    previousPaper = EndFlippingPaper - 1;
                    break;
                default:
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        int index = CurrentPaper - 1;
        if (index < StartFlippingPaper)
        {
            index = EndFlippingPaper ;
        }
  
        Left = papers[index].Front.GetComponent<Image>();
    ...
    //    Debug.Log(Left.gameObject.name);
        ...
        Right = papers[index].Back.GetComponent<Image>();
   ...
   //     Debug.Log(Right.gameObject.name);
    ...
    public void TweenForward()
    {
        ...
        {
            tweening = true;
            CTween.ValueTo(gameObject, f, ebl * 0.98f, 0.3f, TweenUpdate, ()=> {
                Flip();
                tweening = false;
            });
        }
        ...
        {
            tweening = true;
            CTween.ValueTo(gameObject, f, ebr * 0.98f, 0.3f, TweenUpdate, () => {
                Flip();
                tweening = false;
            });
        }
    ...
    public  void GetNextPage()
    {
        if (CurrentPaper % 2 == 0)
        {
            NextPage[0] = papers[0].Back;
            NextPage[1] = papers[1].Front;
        }
        else
        {
            NextPage[0] = papers[0].Front;
            NextPage[1] = papers[1].Back;
        }
    ...
    public void GetNowPage()
    {
        ...
        Debug.Log(NextPage[0].name + "-----" + NextPage[1].name);
    }

...
namespace OuSimpleUI
{
    public class OutlineEx : BaseMeshEffect
    {
        public Color OutlineColor = Color.white;
        [Range(0, 2)] public float OutlineWidth = 0;
        ...
        protected override void Awake()
        {
            ...
            if (base.graphic)
            {
                if (base.graphic.material == null || base.graphic.material.shader.name != "UI/UIOutLine")
                {
#if UNITY_EDITOR
                    var texMaterial = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Res/UI/Font/Number/OutLineMat.mat");
